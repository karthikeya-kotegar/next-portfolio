...
const CustomLink = ({ href, title, className = "" }) => {
  ...
  return (
    <Link href={href} className={`${className} relative group`}>
      ...
      <span
        className={`h-[1px] inline-block bg-dark abolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 ${
...
const CustomMobileLink = ({ href, title, className = "", toggle }) => {
  ...
  return (
    ...
    >
      ...
      <span
        className={`h-[1px] inline-block bg-light abolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 ${
          router.asPath === href ? "w-full" : "w-0"
        } dark:bg-dark`}
      >
        &nbsp;
