...
const Skills = () => {
  return (
    <>
      <h2 className="font-bold text-8xl mt-64 w-full text-center md:mt-32 md:text-6xl">
        Skills
      </h2>

      <div
        className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLigth dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLigthLg lg:dark:bg-circularDarkLg 
      md:bg-circularLigthMd md:dark:bg-circularDarkMd sm:bg-circularLigthSm sm:dark:bg-circularDarkSm "
      >
        <motion.div
