...
const MovingImg = ({ img, title, link }) => {
  ...
  function handleMouse(event) {
    //add style to make hidden image to visible
...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
  return (
    <li className="relative col-span-1 w-full p-4 bg-light border border-solid border-black rounded-2xl dark:border-light dark:bg-dark">
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Karthikeya | Articles Page</title>
        <meta name="description" content="karthikeya's Articles" />
      </Head>
        ...
        <Layout className="pt-16">
          ...
          <ul className="grid grid-cols-2 gap-16">
            ...
            <FeaturedArticle
              ...
              summary="Learn how to build a Redux in ReactJS from
            scratch. Follow this step-by-step guide to integrate Pagination
            component in your ReactJS project. "
              time="10 min read"
              link="/"
